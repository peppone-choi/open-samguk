...
$(function () {
  ...
  const $userFrame: JQuery<HTMLElement> = $(
    '<div id="on_mover" style="position:absolute;">' +
  ...
  $btn.on("click", function () {
    ...
    $tr0.append(
      '<td><strong>*벌점 순 정렬*</strong><br><span style="color:yellow">벌점 1500점 이상</span>, <span style="color:lightgreen">벌점 200점 이상</span>, ' +
        '<span style="text-decoration:line-through">삭턴장</span>, <span style="color:cyan">ⓝ장</span>' +
        "<br><strong>전투장 :</strong> 만능장 + 무장 + 지장 + 평범장 - 삭턴자(만능, 무, 지, 평범) </td>",
    );
  });
