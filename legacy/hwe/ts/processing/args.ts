...
const stringArgs = ["nationName", "optionText", "itemType", "nationType", "itemCode", "commandType"] as const;
const intArgs = [
  "crewType",
  "destGeneralID",
  "destCityID",
...
const booleanArgs = ["isGold", "buyRice"] as const;

const integerArrayArgs = ["destNationIDList", "destGeneralIDList", "amountList"] as const;
...
export function testSubmitArgs(
  args: Args,
): true | ["int" | "string" | "boolean" | "int[]", keyof Args, number | string | boolean | number[]] {
