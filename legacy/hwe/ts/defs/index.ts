...
export type GeneralListResponse = {
  ...
  list: [
    ...
    PublicGeneralItem["picture"],
    PublicGeneralItem["imgsvr"],
    PublicGeneralItem["npc"],
    PublicGeneralItem["age"],
    PublicGeneralItem["nation"],
    PublicGeneralItem["specialDomestic"],
    PublicGeneralItem["specialWar"],
    PublicGeneralItem["personal"],
    PublicGeneralItem["name"],
    PublicGeneralItem["ownerName"],
    PublicGeneralItem["injury"],
    PublicGeneralItem["leadership"],
    PublicGeneralItem["lbonus"],
    PublicGeneralItem["strength"],
    PublicGeneralItem["intel"],
    PublicGeneralItem["explevel"],
    PublicGeneralItem["experienceStr"],
    PublicGeneralItem["dedicationStr"],
    PublicGeneralItem["officerLevelStr"],
    PublicGeneralItem["killturn"],
    PublicGeneralItem["refreshScoreTotal"],
  ][];
