...
- [ ] che_장비매매 (EquipmentTradeCommand)
- [ ] che_주민선정 (DevelopTrustCommand)
- [ ] che_수비강화 (StrengthenDefenseCommand)
- [ ] che_집합 (AssembleCommand)
...
- [ ] che_천도 (ChangeCapitalCommand)
- [ ] che_백성동원 (MobilizeCommand)
- [ ] che_국기변경 (ChangeNationColorCommand)
- [ ] che_감축 (ReduceCapitalCommand)
- [ ] che_국호변경 (ChangeNationNameCommand)
