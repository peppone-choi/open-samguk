...
/**
 * 음귀병 연구 커맨드 - 음귀병(陰鬼兵) 사용 해금
 * 레거시: event_음귀병연구
 * Cost: 금 100,000, 쌀 100,000
 * PreReqTurn: 24턴 (preReqTurn = 23)
 */
export class NationResearchShamanCommand extends GeneralCommand {
  readonly actionName = "음귀병 연구";
  readonly auxKey = NationAuxKey.can_음귀병사용;
