...
/**
 * 산저병 연구 커맨드 - 산저병(山楮兵) 사용 해금
 * 레거시: event_산저병연구
 * Cost: 금 100,000, 쌀 100,000
 * PreReqTurn: 24턴 (preReqTurn = 23)
 */
export class NationResearchMountaineerCommand extends GeneralCommand {
  readonly actionName = "산저병 연구";
  readonly auxKey = NationAuxKey.can_산저병사용;
