...
describe('GeneralSpyCommand', () => {
  ...
  const mockSnapshot: WorldSnapshot = {
    ...
    nations: {
      1: { id: 1, name: '유비군', level: 1, color: '#FFF', capitalCityId: 1, gold: 0, rice: 0, rate: 0, rateTmp: 0, tech: 0, power: 0, typeCode: 'che_중립', gennum: 1, spy: {}, meta: {}, warState: 0, strategicCmdLimit: 0, surrenderLimit: 0, scoutLevel: 0 },
      2: { id: 2, name: '조조군', level: 1, color: '#F00', capitalCityId: 2, gold: 0, rice: 0, rate: 0, rateTmp: 0, tech: 0, power: 0, typeCode: 'che_중립', gennum: 1, spy: {}, meta: {}, warState: 0, strategicCmdLimit: 0, surrenderLimit: 0, scoutLevel: 0 },
    },
    cities: {
      ...
      2: { id: 2, name: '업', nationId: 2, level: 5, supply: 1, pop: 1000, popMax: 1000, agri: 1000, agriMax: 1000, comm: 1000, commMax: 1000, secu: 100, secuMax: 100, def: 100, defMax: 100, wall: 100, wallMax: 100, trust: 100, gold: 0, rice: 0, region: 1, state: 0, term: 0, conflict: {}, meta: {}, front: 0 },
    },
    diplomacy: {}, troops: {}, gameTime: { year: 184, month: 1 }, env: { develcost: 100 },
  };
