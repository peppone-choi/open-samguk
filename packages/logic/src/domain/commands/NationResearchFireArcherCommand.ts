...
/**
 * 화시병 연구 커맨드 - 화시병(火矢兵) 사용 해금
 * 레거시: event_화시병연구
 * Cost: 금 100,000, 쌀 100,000
 * PreReqTurn: 24턴 (preReqTurn = 23)
 */
export class NationResearchFireArcherCommand extends GeneralCommand {
  readonly actionName = "화시병 연구";
  readonly auxKey = NationAuxKey.can_화시병사용;
