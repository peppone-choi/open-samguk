...
/**
 * 원융노병 연구 커맨드 - 원융노병(元戎弩兵) 사용 해금
 * 레거시: event_원융노병연구
 * Cost: 금 100,000, 쌀 100,000
 * PreReqTurn: 24턴 (preReqTurn = 23)
 */
export class NationResearchRatanCommand extends GeneralCommand {
  readonly actionName = "원융노병 연구";
  readonly auxKey = NationAuxKey.can_원융노병사용;
