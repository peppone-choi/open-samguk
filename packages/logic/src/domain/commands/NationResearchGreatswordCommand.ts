...
/**
 * 대검병 연구 커맨드 - 대검병(大劍兵) 사용 해금
 * 레거시: event_대검병연구
 * Cost: 금 100,000, 쌀 100,000
 * PreReqTurn: 24턴 (preReqTurn = 23)
 */
export class NationResearchGreatswordCommand extends GeneralCommand {
  readonly actionName = "대검병 연구";
  readonly auxKey = NationAuxKey.can_대검병사용;
