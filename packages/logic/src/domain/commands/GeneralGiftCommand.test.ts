...
describe('GeneralGiftCommand', () => {
  ...
  const mockSnapshot: WorldSnapshot = {
    generals: {
      1: {
        id: 1, name: '보내는장수', nationId: 1, cityId: 1, gold: 5000, rice: 5000,
      ...
      2: {
        id: 2, name: '받는장수', nationId: 1, cityId: 1, gold: 100, rice: 100,
        leadership: 50, leadershipExp: 0, strength: 50, strengthExp: 0, intel: 50, intelExp: 0, politics: 50, politicsExp: 0, charm: 50, charmExp: 0,
        injury: 0, experience: 1000, dedication: 1000, crew: 0, crewType: 0, train: 0, atmos: 0, age: 20, turnTime: new Date(),
        killTurn: 0, meta: {}, penalty: {}, officerLevel: 1, officerCity: 1, ownerId: 2, bornYear: 180, deadYear: 280,
        weapon: '', book: '', horse: '', item: '', recentWarTime: null, makeLimit: 0, block: 0, recentWar: 0,
        dex: {}, special: '', specAge: 0, special2: '', specAge2: 0, defenceTrain: 80, tournamentState: 0, lastTurn: {}
      }
    },
    nations: {
      1: { id: 1, name: '국가1', color: '#FF0000', capitalCityId: 1, gold: 10000, rice: 10000, rate: 10, rateTmp: 10, tech: 0, power: 1000, level: 1, gennum: 2, typeCode: 'che_중립', scoutLevel: 0, warState: 0, strategicCmdLimit: 36, surrenderLimit: 72, spy: {}, meta: {}, chiefGeneralId: 1 }
    },
    cities: {
  ...
  it('금 1000을 증여해야 함', () => {
    ...
    const delta = cmd.run(rand, mockSnapshot, 1, { isGold: true, amount: 1000, destGeneralId: 2 });
  ...
  it('최소 유지 비용(금 0, 쌀 500)을 제외하고 증여해야 함', () => {
    ...
    const delta = cmd.run(rand, mockSnapshot, 1, { isGold: false, amount: 5000, destGeneralId: 2 });
