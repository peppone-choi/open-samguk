...
describe('GeneralAgitateCommand', () => {
  ...
  const mockSnapshot: WorldSnapshot = {
    ...
    cities: {
      ...
      2: { id: 2, name: '허창', nationId: 2, supply: 1, pop: 10000, popMax: 10000, agri: 1000, agriMax: 1000, comm: 1000, commMax: 1000, secu: 100, secuMax: 100, def: 100, defMax: 100, wall: 100, wallMax: 100, trust: 100, gold: 0, rice: 0, region: 1, state: 0, term: 0, conflict: {}, meta: {}, level: 1, front: 0 },
    },
    diplomacy: {},
    troops: {},
  ...
  it('인접한 적국 도시에 선동을 시도해야 함', () => {
    ...
    snapshotWithConnected.cities[18] = { ...snapshotWithConnected.cities[2], id: 18, name: '복양', nationId: 2 };
