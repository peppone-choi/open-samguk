...
const RAW_CITIES: [number, string, string, number, number, number, number, number, number, string, number, number, string[]][] = [
...
export class MapUtil {
  ...
  private static initialize() {
    ...
    for (const raw of RAW_CITIES) {
      const [id, name, levelStr, pop, agri, comm, secu, def, wall, regionStr, x, y, connections] = raw;
