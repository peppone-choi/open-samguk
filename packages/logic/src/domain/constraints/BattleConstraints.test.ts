...
describe("BattleConstraints", () => {
    describe("BattleGroundCityConstraint", () => {
        it("교전 중인 상태('0')면 통과해야 함", () => {
            ...
            const diplomacy: Diplomacy = { id: 1, srcNationId: 1, destNationId: 2, state: "0", term: 12, meta: {} };
    ...
    describe("AllowRebellionConstraint", () => {
        ...
        it("군주가 비활동 중이고 유저장이면 통과해야 함", () => {
            ...
            const ctx = { actorId: 1, nationId: 1, args: {}, env: { killturn: 20 }, mode: "full" as const };
