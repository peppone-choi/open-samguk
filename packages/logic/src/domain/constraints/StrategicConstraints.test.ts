...
describe("StrategicConstraints", () => {
    const mockNation = (id: number, overrides: Partial<Nation> = {}): Nation => ({
        id, name: `N${id}`, color: "", chiefGeneralId: 0, capitalCityId: 0, gold: 0, rice: 0, rate: 0, rateTmp: 0, tech: 0, power: 0, level: 1, gennum: 0, typeCode: "", scoutLevel: 0, strategicCmdLimit: 0, surrenderLimit: 0, spy: {}, aux: {}, meta: {}, warState: 0, ...overrides
    });
