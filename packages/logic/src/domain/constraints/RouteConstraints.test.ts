...
describe("RouteConstraints", () => {
    ...
    const baseSnapshot: WorldSnapshot = {
        ...
        diplomacy: {}, troops: {}, messages: {}, gameTime: { year: 0, month: 0 }, env: {}
    };
