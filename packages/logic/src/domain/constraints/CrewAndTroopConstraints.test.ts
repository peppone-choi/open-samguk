...
describe("CrewAndTroopConstraints", () => {
    const mockGeneral = (id: number, overrides: Partial<General> = {}): General => ({
        id, name: `G${id}`, nationId: 1, cityId: 1, npc: 0, gold: 0, rice: 0, leadership: 10, leadershipExp: 0, strength: 0, strengthExp: 0, intel: 0, intelExp: 0, politics: 0, politicsExp: 0, charm: 0, charmExp: 0, injury: 0, experience: 0, dedication: 0, officerLevel: 0, officerCity: 0, recentWar: 0, crew: 0, crewType: 1, train: 0, atmos: 0, dex: {}, age: 0, bornYear: 0, deadYear: 0, special: "", specAge: 0, special2: "", specAge2: 0, weapon: "", book: "", horse: "", item: "", turnTime: new Date(), recentWarTime: null, makeLimit: 0, killTurn: 0, block: 0, defenceTrain: 0, tournamentState: 0, lastTurn: {}, meta: {}, penalty: {}, ownerId: 1, troopId: 0, ...overrides
    });
    ...
    describe("ReqTroopMembersConstraint", () => {
        it("부대에 본인 외의 멤버가 있으면 허용해야 함", () => {
            ...
            const snapshot: WorldSnapshot = {
                generals: { 1: g1, 2: g2 },
                nations: {}, cities: {}, diplomacy: {}, troops: {}, gameTime: { year: 0, month: 0 }, env: {}
            };
