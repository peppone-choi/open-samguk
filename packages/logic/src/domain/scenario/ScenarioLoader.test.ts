...
import { ScenarioLoader, ScenarioValidationError, OFFICER_LEVEL, NATION_LEVEL } from './ScenarioLoader.js';
    ...
    describe('ScenarioSchema', () => {
        ...
        it('역사 시나리오를 파싱한다', () => {
            const historicalScenario = {
                ...
                diplomacy: [],
                general: [
                    [1, '소제1', 1001, 1, null, 20, 11, 48, 0, 168, 190, '유지', null],
                ],
            };
    ...
    describe('validate', () => {
        ...
        it('유효한 시나리오를 검증한다', () => {
            const scenario = {
                ...
                startYear: 180,
                nation: [
                    ['위', '#FF0000', 5000, 5000, '위나라', 1000, '법가', 5, ['업']],
                ],
            };
    ...
    describe('toWorldState', () => {
        ...
        it('시나리오를 WorldSnapshot으로 변환한다', async () => {
            const scenario: Scenario = {
                ...
                general: [
                    [1, '조조', null, '위', '낙양', 96, 72, 91, 12, 155, 220, '패권', '신산'],
                ],
            };
...
describe('InitialEventRunner', () => {
    ...
    describe('evaluateCondition', () => {
        ...
        it('Date 조건을 평가한다', () => {
            // 연도만 비교
            expect(runner.evaluateCondition(
                ['Date', '>=', 183, null],
                mockSnapshot,
                mockContext
            )).toBe(true);
    ...
    describe('runInitialEvents', () => {
        ...
        it('조건이 false인 이벤트는 실행하지 않는다', () => {
            const scenario: Scenario = {
                ...
                startYear: 180,
                initialEvents: [
                    [false, ['NoticeToHistoryLog', '실행되지 않음']],
                ],
            };
