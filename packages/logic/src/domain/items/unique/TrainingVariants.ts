...
export class TrainingLiquor2Item extends BaseItem {
  ...
  onCalcStat(_general: GeneralReadOnly, statName: StatName, value: number): number {
    if (statName === "bonusTrain") return value + 10;
    return value;
  }
...
export class TrainingBookItem extends BaseItem {
  ...
  onCalcStat(_general: GeneralReadOnly, statName: StatName, value: number): number {
    if (statName === "bonusTrain") return value + 15;
    return value;
  }
